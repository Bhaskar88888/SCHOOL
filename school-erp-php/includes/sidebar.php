...
$icons = [
    ...
    'fee_structures'   => nav_svg('<rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/>'),
    'hostel_setup'     => nav_svg('<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><circle cx="12" cy="15" r="2"/>'),
    ...
    'departments'      => nav_svg('<path d="M3 21h18"/><path d="M5 21V7l8-4v18"/><path d="M19 21V11l-6-3"/><path d="M9 9h1"/><path d="M9 13h1"/><path d="M9 17h1"/>'),
...
$navItems = [
    ...
    ['key' => 'fee_structures',   'label' => 'Fee Structures',   'roles' => ['superadmin','admin','accounts','accountant']],
    ['key' => 'exams',            'label' => 'Exams',            'roles' => ['superadmin','admin','teacher']],
    ['key' => 'hr',               'label' => 'HR / Staff',       'roles' => ['superadmin','admin']],
    ['key' => 'departments',      'label' => 'Departments',      'roles' => ['superadmin','admin','hr']],
    ...
    ['key' => 'hostel_setup',     'label' => 'Hostel Setup',     'roles' => ['superadmin','admin']],
    ['key' => 'transport',        'label' => 'Transport',        'roles' => ['superadmin','admin','conductor','driver']],
    ...
    ['key' => 'notices',          'label' => 'Notices',          'roles' => ['superadmin','admin','teacher','student','parent','conductor','driver']],
    ...
    ['key' => 'messages',         'label' => 'Messages',         'roles' => ['superadmin','admin','teacher','student','parent','accounts','accountant','librarian','hr','canteen','conductor','driver']],
    ['key' => 'chatbot',          'label' => 'AI Chatbot',       'roles' => ['superadmin','admin','teacher','student','parent','accounts','accountant','librarian','conductor','driver']],
